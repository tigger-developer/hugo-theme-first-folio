---
title: "Three Things I Learned from a Broken Compass"
date: 2025-09-20
description: "A short reflective piece demonstrating the details and callout shortcodes."
tags:
  - reflection
  - shortcodes
image:
...
{{< details "Thing one: certainty is overrated" >}}
...
{{< details "Thing two: all tools are extensions of intention" >}}
...
{{< details "Thing three: keep the broken things" >}}
...
{{< callout type="custom" title="Note" text="This piece exists to demonstrate the details and callout shortcodes. The compass is fictional. The sentiment is not." style="background: var(--bg-secondary);" >}}
