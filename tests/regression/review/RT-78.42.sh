...
# ABOUTME: RT-78.42 - book reviews demonstrate each named review-relevant layout family once.
# ABOUTME: The section contains banner, hero, featured, background, and one columns page.
...
run_test() {
    ...
    [[ -n "$(htmlq -f "$build_dir/book-reviews/the-glass-archive/index.html" '.columns-layout .review-metadata--book')" ]]
}
